...
public class CommonConfig extends ConfigBase {
    ...
    public final ConfigBool renderCasings = b(false, "renderCasings", Comments.renderCasings);
    @Override
    ...
    private static class Comments {
        ...
        static String renderCasings = "Whether to render additional shaft casing geometry on cogwheels";
    }
}
